...
namespace TP2
{
    ...
    public abstract class Producto
    {
        ...
        public Producto(string codigoDeBarras, ConsoleColor color, EMarca marca)
        {    
        ...
        public static explicit operator string(Producto producto)
        {
            ...
            sb.AppendFormat("CODIGO DE BARRAS: {0}\r\n", producto._codigoDeBarras);
            sb.AppendFormat("MARCA  : {0}\r\n", producto._marca.ToString());
            sb.AppendFormat("COLOR EMPAQUE : {0}\r\n", producto._colorPrimarioEmpaque.ToString());
            sb.AppendLine("---------------------");
